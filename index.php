...
<html>
    ...
    <head>
        ...
        MailChimp automatically inlines CSS for you or you can use this tool: http://beaker.mailchimp.com/inline-css. */
			...
			img{border:none; font-size:14px; font-weight:bold; height:auto; line-height:100%; outline:none; text-decoration:none; text-transform:capitalize; width:100%;}
	        ...
	        <table id="bodyTable" border="0" cellpadding="0" cellspacing="0" height="100%" width="100%">
	            <tr>
	                <td align="center" valign="top">
	                    <table id="emailContainer" border="0" cellpadding="0" cellspacing="0" width="100%">
	                        <tr>
	                            <td align="center" valign="top">
	                            <!-- content begins -->
									...
									<!-- intro begins -->
									<table class="intro-container" border="0" cellpadding="0" cellspacing="0" width="100%">
										<tr>
											<td align="center" valign="top">
												<!-- right align content -->
									...
									<!-- divider begins -->
									<table class="divider" border="0" cellpadding="0" cellspacing="0" height="10px" width="100%">
										<tr>
									...
									<!-- social begins -->
									<table class="social-container" border="0" cellpadding="0" cellspacing="0" width="100%">
										<tr>
											<td align="center" valign="top">
												<table class="media-width" border="0" cellpadding="0" cellspacing="0">
													<tr>
									...
									<!-- contact begins -->
									<table class="contact-container" border="0" cellpadding="0" cellspacing="0" width="100%">
										<tr>
											<td align="center" valign="top">
												<!-- right align content -->
												<table class="media-width" border="0" cellpadding="0" cellspacing="0">
									...
									<!-- footer begins -->
									<table class="footer-container" border="0" cellpadding="0" cellspacing="0" width="100%">
										<tr>
											<td align="center" valign="top">
												<!-- right align content -->
												<table class="media-width" border="0" cellpadding="0" cellspacing="0">
